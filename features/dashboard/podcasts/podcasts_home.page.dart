...
import 'podcasts_home.model.dart';

class PodcastsHomePage extends StatefulWidget {
  const PodcastsHomePage({Key? key}) : super(key: key);

  @override
  State<PodcastsHomePage> createState() => _PodcastsHomePageState();
}

class _PodcastsHomePageState extends PageState<PodcastsHomePage>
    with AutomaticKeepAliveClientMixin<PodcastsHomePage> {
  //=
  ...
  void initState() {
    ...
    context.read<PodcastsHomeModel>().init();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return PageTitleBarWrapper(
      ...
      title: DashboardPageTitle(
          text: LocaleResources.of(context).tabPodcasts,
      ...
      child: ItemListWidget<Feed, PodcastsHomeModel>(
  ...
  Widget _buildTitle() {
    return Container(
      ...
      child: Text(LocaleResources.of(context).tabPodcasts,
  ...
  Widget _buildSearchBar() {
    return ScaleTap(
      ...
      child: AbsorbPointer(
          child: SearchBar(
              hintText: LocaleResources.of(context).radioHomeSearchHint)),
    );
  }

  void _onSearchBarTap() {
    DashboardNavigation.pushNamed(context, Routes.search,
        arguments: SearchArgs(source: SearchSource.radioHome));
  }
}
